...
namespace MelonLoader.Il2CppAssemblyGenerator
{
    internal static class Core
    {
        ...
        internal static string OutputManagedPath = null;
        ...
        static Core()
        {
            ...
            OutputManagedPath = MelonUtils.GetEmulatedManagedDirectory();

            Directory.CreateDirectory(OutputManagedPath);
        ...
        private static void OldFiles_Cleanup()
        {
            ...
            for (int i = 0; i < Config.Values.OldFiles.Count; i++)
            {
                ...
                string filepath = Path.Combine(OutputManagedPath, filename);
        ...
        private static void OldFiles_LAM()
        {
            ...
            for (int i = 0; i < filepathtbl.Length; i++)
            {
                ...
                string newfilepath = Path.Combine(OutputManagedPath, filename);
