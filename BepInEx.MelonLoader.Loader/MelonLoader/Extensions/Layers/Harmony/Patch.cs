...
namespace Harmony
{
	...
	public static class PatchInfoSerialization
	{
		...
		public static PatchInfo Deserialize(byte[] bytes)
			=> throw new Exception("Unsupported HarmonyX method: Deserialize"); //(PatchInfo)HarmonyLib.PatchInfoSerialization.Deserialize(bytes);
		...
		public static int PriorityComparer(object obj, int index, int priority, string[] before, string[] after)
			=> throw new Exception("Unsupported HarmonyX method: PriorityComparer"); //HarmonyLib.PatchInfoSerialization.PriorityComparer(obj, index, priority);
	}
	...
	public class PatchInfo : HarmonyLib.PatchInfo
	{
		...
		public void AddPrefix(MethodInfo patch, string owner, int priority, string[] before, string[] after)
			=> throw new Exception("Unsupported HarmonyX method: AddPrefix"); //AddPrefixes(owner, new HarmonyLib.HarmonyMethod(patch, priority, before, after, false));
		...
		public void AddPostfix(MethodInfo patch, string owner, int priority, string[] before, string[] after)
			=> throw new Exception("Unsupported HarmonyX method: AddPostfixes"); //AddPostfixes(owner, new HarmonyLib.HarmonyMethod(patch, priority, before, after, false));
		...
		public void AddTranspiler(MethodInfo patch, string owner, int priority, string[] before, string[] after)
			=> throw new Exception("Unsupported HarmonyX method: AddTranspilers"); //AddTranspilers(owner, new HarmonyLib.HarmonyMethod(patch, priority, before, after, false));
	}
