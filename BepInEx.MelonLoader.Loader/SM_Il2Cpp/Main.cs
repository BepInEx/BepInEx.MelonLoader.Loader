...
namespace MelonLoader.Support
{
	internal static class Main
    {
        ...
        private static void SetDefaultConsoleTitleWithGameName(string GameVersion = null)
		{
            // this is the proper implementation of this method in C#, however it's commented out since we're not going to override the console title

            //ConsoleManager.SetConsoleTitle($"MelonLoader {BuildInfo.Version} ALPHA Pre-Release - {MelonUtils.GameName} {GameVersion}");
		}
    }
}